...
from modules.gatk_gCNV import Gatk_gCNV
...
Mosdepth_Metrics_Df = Mosdepth_df()
...
# array containing samples with downlodaded bams/bais
...
# pca_plot_path = os.path.join(ref_conf.main_dir, "normalized_mosdepth_PCA_plot.html")
# umap_plot_path = os.path.join(ref_conf.main_dir, "normalied_mosdepth_umap_plot.html")
# heatmap_path = os.path.join(ref_conf.main_dir, "Mosdepth_heatmap.png")
# Mosdepth_Metrics_Df.apply_pca(pca_plot_path, normalized=True)
